...
public class PaymentServlet extends HttpServlet{
    ...
    public PaymentServlet(PaymentService service) {
    ...
    protected void process(HttpServletResponse resp, String amount, String status, String payload, String timestamp, String md5) throws IOException {
        try {
