...
public class PaymentServlet extends HttpServlet{
    ...
    public PaymentServlet() {
        ...
        requestSignatureValidator = new RequestSignatureValidator();
    }

    public PaymentServlet(PaymentService paymentService, RequestSignatureValidator requestSignatureValidator) {
    ...
    void process(HttpServletResponse resp, String amount, String status, String payload, String timestamp, String md5) throws IOException {
        try {
            requestSignatureValidator.validate(amount, status, payload, timestamp, md5);
